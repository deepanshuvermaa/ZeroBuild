              ...
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-sm text-white placeholder-white/20 focus:border-white/30 focus:outline-none"
                  />
                  <textarea
                    value={text}
                    ...
                    rows={3}
                    required
                    className="w-full rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-sm text-white placeholder-white/20 focus:border-white/30 focus:outline-none resize-none"
                  />
                  <button
                    type="submit"
                    disabled={loading || !text.trim()}
                    className="w-full flex items-center justify-center gap-2 rounded-xl bg-white py-2 text-sm font-semibold text-black hover:bg-gray-200 transition-colors disabled:opacity-40"
                  >
